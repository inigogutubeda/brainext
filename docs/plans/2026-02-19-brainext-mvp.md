...
**Tech Stack:** Expo SDK 54, React Native, TypeScript, Supabase (PostgreSQL + GoTrue auth), React Navigation v7, Zustand, NativeWind v4, Jest, @testing-library/react-native
